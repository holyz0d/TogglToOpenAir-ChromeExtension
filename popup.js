...
function createTogglClient(apiKey, workspaceId, clientName) {
    return postTogglData("https://api.track.toggl.com/api/v9/clients", apiKey, { client: { name: clientName, wid: workspaceId } });
}
...
function createTogglProject(apiKey, workspaceId, projectName, clientId) {
    return postTogglData("https://api.track.toggl.com/api/v9/projects", apiKey, { project: { name: projectName, wid: workspaceId, cid: clientId, is_private: true } });
}

function archiveTogglProject(apiKey, projectId) {
    return putTogglData("https://api.track.toggl.com/api/v9/projects/" + projectId, apiKey, { project: { is_private: true, active: false } });
}

function unarchiveTogglProject(apiKey, projectId) {
    return putTogglData("https://api.track.toggl.com/api/v9/projects/" + projectId, apiKey, { project: { is_private: true, active: true } });
}
